...
def main(params):
    ...
    experiment = Experiment(api_key=comet_api_key, project_name=comet_project, workspace=comet_workspace, experiment_config=ExperimentConfig(name=f"{params.model_name}_{params.stage}_{params.tgt_lang}", tags=[params.stage, params.tgt_lang]))
